...
const SvgStoryOutline20 = (props: SVGProps<SVGSVGElement>) => (
	<svg
		width={20}
		height={20}
		fill='none'
	...
	>
		<path
			fillRule='evenodd'
			clipRule='evenodd'
			d='M10 6.25a3.75 3.75 0 1 0 0 7.5 3.75 3.75 0 0 0 0-7.5ZM7.75 10a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0Z'
			fill='#99A2AD'
		/>
		<path
			fillRule='evenodd'
...
export default SvgStoryOutline20
