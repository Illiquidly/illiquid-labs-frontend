							...
							<ModalBody>
								<Flex sx={{ gap: '8px' }}>
									...
									<Flex sx={{ flex: 1, flexDirection: 'column' }}>
										<Title>{t('raffle-listings:remove-modal.question')}</Title>
										<Subtitle>{t('raffle-listings:remove-modal.answer')}</Subtitle>
									</Flex>
								</Flex>
								<RadioInputGroupProvider
									name='confirmStatus'
								...
								>
									<RadioCard value={CONFIRM_STATUS_TYPE.CONFIRMED}>
										<RadioText>{t('raffle-listings:remove-modal.radio-text')}</RadioText>
									</RadioCard>
								</RadioInputGroupProvider>
								<Flex
									sx={{
